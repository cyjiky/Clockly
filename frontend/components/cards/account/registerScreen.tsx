...
import type { RegisterBodyDTO } from "@/constants/props/authProps";
...
export default function RegisterScreen({ isOpen, onClose }: ExtendedActionButtonsProps) {
    // const [confirmPassword, setConfirmPassword] = useState('');

    const [formData, setFormData] = useState<RegisterBodyDTO>({
        username: "",
        password: "",
        email: "",
    });
    ...
    const handleChange = (field: keyof RegisterBodyDTO, value: string) => {
            ...
            >
              ...
              >
                ...
                <View className="flex-col">
                  ...
                  <Text className="text-sm font-semibold text-slate-800 mt-2 mb-2 ml-1">Password</Text>
